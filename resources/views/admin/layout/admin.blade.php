...
<head>
    ...
    <title>Dashboard | CNC Production - Admin & Dashboard</title>
    ...
    <style>
        ...
        input:focus {
            ...
            border: 3px solid #435590;
        }

        input[readonly] {
            outline: 2px solid var(--vz-input-border);
        }
                ...
                <div class="p-4">
                    ...
                    <div id="layout-position">
                        ...
                        <div class="btn-group radio" role="group">
                            ...
                            <label class="btn btn-light w-sm" for="layout-position-fixed">Fixed</strong>

                                <input type="radio" class="btn-check" name="data-layout-position"
                                    id="layout-position-scrollable" value="scrollable">
                                <label class="btn btn-light w-sm ms-0"
                                    for="layout-position-scrollable">Scrollable</strong>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).keyup(function(e) {
            ...
            if (e.which == 65 && isCtrl == true) {
                ...
                window.location.href = $('.redirect_page').data('href');
                return false;
            }
        });


        $(document).on('click', '#FilerBtnAjax', function(e) {
            $('#filter_frm').submit();
        });
        ...
        //     }
        // });
        // $('#filter_frm').keypress(function(e) {
        //     var key = e.which;
        ...
        $('.search_submit').on('change', function() {

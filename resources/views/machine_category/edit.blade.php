 ...
 {{-- <div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Machine Category</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Machine Category</a></li>
                    ...
                    <div class="card card-animate">
                        <div class="card-header">
                            <div class="row align-items-left">
                                <div class="col">
                                    <h2 class="card-title-lg">Edit Machine Category</h2>
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($machine_category, ['method' => 'PATCH','route' => ['machine_category.update', $machine_category->id]]) !!}
                                  
                                    <!-- <input type="hidden" name="id" value="{{$machine_category->id}}"> -->
                                    <div class="form-group">
                                        <strong>Name</strong>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="name"
                                                id="name" placeholder="Enter name" value="{{$machine_category->name}}" required>
                                        </div>
                                    </div>

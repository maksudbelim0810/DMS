        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Batch Master</a></li>
                    <li class="breadcrumb-item active">Edit Batch Master</li>
                </ol>
            </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Batch Master
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    {!! Form::model($BatchNumber, ['method' => 'PATCH', 'route' => ['batch_number.update', $BatchNumber->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>Batch Name:</strong>
                                                {!! Form::text('batch_name', $BatchNumber->batch_name, [
                                                ...
                                                <select name="part_name" id="part_name" class="form-control mySelect2" required>
                                                    ...
                                                    @foreach ($part_category as $value)
                                                        <option value="{{ $value->part_name }}"
                                                            ...
                                                            @if ($value->part_name == $BatchNumber->part_name) selected @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                <input type="text" value="{{$BatchNumber->customer_name}}" class="form-control" name="customer_name" id="customer_name" tabindex="-1" onclick="return false" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>Part Type Category :</strong>
                                                <input type="text" value="{{$BatchNumber->part_type_category}}" class="form-control" name="part_type_category" id="part_type_category" tabindex="-1" onclick="return false" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::date('batch_start_date', $BatchNumber->batch_start_date, ['class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>Batch Comp Date:</strong>
                                                {!! Form::date('batch_comp_date', $BatchNumber->batch_comp_date, ['class' => 'form-control']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::text('batch_qty', $BatchNumber->batch_qty, [

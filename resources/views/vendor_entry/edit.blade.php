                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Vendor Master
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    {!! Form::model($VendorEntry, ['method' => 'PATCH', 'route' => ['vendor_entry.update', $VendorEntry->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>Vendor Name:</strong>
                                                {!! Form::text('vendor_name', $VendorEntry->vendor_name, [
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::select('vendor_category_id', $VendorCate, $SelectedVendorCate, [
                                                    'class' => 'form-control',
                                                    'required',
                                                ]) !!}
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::text('contact_person', $VendorEntry->contact_person, [
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::number('mobile_number', $VendorEntry->mobile_number, [

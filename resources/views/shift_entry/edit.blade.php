        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit Shift Master</li>
                </ol>
            </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Shift Master</h2>
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    {!! Form::model($ShiftEntry, ['method' => 'PATCH', 'route' => ['shift_entry.update', $ShiftEntry->id]]) !!}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>Shift Name:</strong>
                                                {!! Form::text('shift_name', $ShiftEntry->shift_name, [
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::number('shift_duration', $ShiftEntry->shift_duration, [
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::number('insert_change', $ShiftEntry->insert_change, [
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::number('lunch_recess', $ShiftEntry->lunch_recess, [
                                                    'placeholder' => 'Lunch Recess',
                                                    'class' => 'form-control',
                                                    'required',
                                                ]) !!}
                                            </div>

                    ...
                    <div class="card card-animate">
                        <div class="card-header">
                            <div class="row align-items-left">
                                <div class="col">
                                    <h2 class="card-title-lg">Add Mc. Opration Master
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(array('route' => 'machine_opration.store','method'=>'POST')) !!}
                                    <div class="form-group">
                                        <strong>Name</strong>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="machine_opration"
                                                id="machine_opration" placeholder="Enter name" required>
                                        </div>
                                    </div>

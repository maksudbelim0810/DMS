                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Part Master
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    {!! Form::model($part_entry, ['method' => 'PATCH', 'route' => ['part_entry.update', $part_entry->id]]) !!}
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control part_n" name="part_no"
                                                        id="part_no" value="{{ $part_entry->part_no }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="part_category" class="form-control mySelect2 part_n"
                                                        required>
                                                        <option value="">--Select Part--</option>
                                                        @foreach ($part_category as $value)
                                                            <option value="{{ $value->part_category }}"
                                                                @if ($value->part_category == $part_entry->part_category) selected @endif>
                                                                {{ $value->part_category }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control part_customer"
                                                        name="part_name" id="part_name" value="{{ $part_entry->part_name }}"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="part_type_category" class="form-control mySelect2"
                                                        required>
                                                        <option value="">--Select Part Type--</option>
                                                        @foreach ($part_type_category as $value)
                                                            <option value="{{ $value->part_type_category }}"
                                                                @if ($value->part_type_category == $part_entry->part_type_category) selected @endif>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="customer_name" id="customer_name"
                                                        class="form-control part_customer mySelect2" required>
                                                        @foreach ($customer as $value)
                                                            <option value="{{ $value->name }}"
                                                                @if ($value->name == $part_entry->customer_name) selected @endif>
                                                                {{ $value->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name="part_and_customer_name"
                                                        id="part_and_customer_name"
                                                        value="{{ $part_entry->part_and_customer_name }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name="drg_rev_edit_no_date"
                                                        ...
                                                        value="{{ $part_entry->drg_rev_edit_no_date }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        ...
                                                        class="form-control" name="forging_rate" id="forging_rate"
                                                        value="{{ $part_entry->forging_rate }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;"
                                                        class="form-control" name="prof_mc_rate" id="prof_mc_rate"
                                                        value="{{ $part_entry->prof_mc_rate }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;"
                                                        class="form-control" name="cnc_rate" id="cnc_rate"
                                                        value="{{ $part_entry->cnc_rate }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;"
                                                        class="form-control" name="mpi_rate" id="mpi_rate"
                                                        value="{{ $part_entry->mpi_rate }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;"
                                                        class="form-control" name="visual_rate" id="visual_rate"
                                                        value="{{ $part_entry->visual_rate }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;" step="0.01"
                                                        class="form-control" name="forging_w" id="forging_w"
                                                        value="{{ $part_entry->forging_w }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;" step="0.01"
                                                        class="form-control" name="proof_mc_w" id="proof_mc_w"
                                                        value="{{ $part_entry->proof_mc_w }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0"
                                                        oninput="this.value = Math.abs(this.value)"
                                                        onKeyPress="if(this.value.length==3) return false;" step="0.01"
                                                        class="form-control" name="finish_w" id="finish_w"
                                                        value="{{ $part_entry->finish_w }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

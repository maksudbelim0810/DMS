                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Add Employee Master
                            ...
                            <div class="card-body cnc_select_form">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    {!! Form::open(['route' => 'employee_bio_data.store', 'method' => 'POST']) !!}
                                    <div class="row align-items-left">
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1 full_name" name="surname"
                                                        id="surname" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="date" min="1900-01-01" max="2500-01-01" class="form-control1"
                                                        name="date_of_company_join" id="date_of_company_join" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-group">
                                                <strong></strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1" name="educational_qualification_2"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1"
                                                        name="training_if_taken_any_1" id="training_if_taken_any_1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1"
                                                        name="training_if_taken_any_2" id="training_if_taken_any_2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1"
                                                        name="training_if_taken_any_3" id="training_if_taken_any_3">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1"
                                                        name="training_if_taken_any_4" id="training_if_taken_any_4">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="Oemcname" id="Oemcname" required
                                                        class="form-control1 mySelect2">

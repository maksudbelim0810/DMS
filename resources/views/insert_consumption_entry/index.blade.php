                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <h4 class="card-title">Insert Consumption Entry
                                    @can('insert_consumption_entry-create')
                                        <a href="{{ route('insert_consumption_entry.create') }}"
                                            class="btn btn-primary redirect_page" data-toggle="tooltip"
                                            title="Ctrl+A to New Entry!" style="float: right;"
                                            data-href="{{ route('insert_consumption_entry.create') }}">
                                            + Add Insert Consumption Entry
                                        </a>
                                    </h4>
                                @endcan
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    <thead class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th>Insert Name</th>
                                            <th>Insert Rate</th>
                                            <th>Insert Cost/Nos</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse ($insert_consumption_entry as $key => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->insert_name }}</td>
                                                <td style="text-align-last: right;">{{ $item->insert_rate_rs }}</td>
                                                <td style="text-align-last: right;">{{ $item->insert_cost_nos }}</td>
                                                <td class="text-center">
                                                    @can('insert_consumption_entry-edit')
                                                        <a class="btn btn-primary"
                                                            href="{{ route('insert_consumption_entry.edit', $item->id) }}"><i
                                                                class="bx bx-pencil"></i>
                                                        </a>
                                                    @endcan
                                                    @can('insert_consumption_entry-delete')
                                                        {!! Form::open([
                                                            'method' => 'DELETE',
                                                            'route' => ['insert_consumption_entry.destroy', $item->id],
                                ...
                                <div class="d-flex justify-content-center">
                                    {!! $insert_consumption_entry->withQueryString()->links() !!}
                                </div>

                        ...
                        <div class="card card-animate">
                            {{-- <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Edit Visual & Packing
                            ...
                            <div class="card-body cnc_select_form">
                                <div class="tab-pane fade show active" id="LogIn_Tab" role="tabpanel">
                                    {!! Form::model($visual_packing, [
                                        'method' => 'PATCH',
                                        'route' => ['visual_packing.update', $visual_packing->id],
                                    ]) !!}
                                    <div class="row align-items-left">
                                        <div class="col text-center">
                                            <h4 class="card-title-lg">Edit Visual & Packing</h4>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <div class="row align-items-left">
                                                    ...
                                                    <select name="location" class="form-control1 mySelect2" required>
                                                        ...
                                                        @foreach ($location as $value)
                                                            <option value="{{ $value->location_name }}"
                                                                @if ($value->location_name == $visual_packing->location) selected @endif>
                                                                {{ $value->location_name }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="date" min="1900-01-01" max="2500-01-01" class="form-control1" name="date" id="date"
                                                        value="{{ date('Y-m-d',strtotime($visual_packing->date) )}}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                                    ...
                                                    <select name="shift" class="form-control1 mySelect2" id="shift" required>
                                                        ...
                                                        @foreach ($shift as $value)
                                                            <option value="{{ $value->shift_name }}"
                                                                @if ($value->shift_name == $visual_packing->shift) selected @endif>
                                                                {{ $value->shift_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="batch_no" class="form-control1 mySelect2" id="batch_no" required>
                                                        <option value="{{$visual_packing->batch_no}}"
                                                            data-batch_qty="{{ $visual_packing->batch_number->batch_qty }}"
                                                            >{{$visual_packing->batch_no}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1" name="part_name"
                                                        id="part_name" value="{{ $visual_packing->part_name }}" tabindex="-1" onclick="return false" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control1" name="customer"
                                                        id="customer" value="{{ $visual_packing->customer }}" tabindex="-1" onclick="return false" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                                    ...
                                                    <select name="incharge_name" class="form-control1 mySelect2" required>
                                                        ...
                                                        @foreach ($incharge as $value)
                                                            <option value="{{ $value->full_name }}"
                                                                @if ($value->full_name == $visual_packing->incharge_name) selected @endif>
                                                                {{ $value->full_name }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="lod"
                                                        id="lod" value="{{ $visual_packing->lod }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="bore"
                                                        id="bore" value="{{ $visual_packing->bore }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="width"
                                                        id="width" value="{{ $visual_packing->width }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="pos_loc"
                                                        id="pos_loc" value="{{ $visual_packing->pos_loc }}" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="flange"
                                                        id="flange" value="{{ $visual_packing->flange }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="sod"
                                                        id="sod" value="{{ $visual_packing->sod }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="uc_dia"
                                                        id="uc_dia" value="{{ $visual_packing->uc_dia }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="track"
                                                        id="track" value="{{ $visual_packing->track }}" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="ovality"
                                                        id="ovality" value="{{ $visual_packing->ovality }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="damage"
                                                        id="damage" value="{{ $visual_packing->damage }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <strong>Od</strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1  section1" name="od"
                                                        id="od" value="{{ $visual_packing->od }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <strong>Bore</strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1  section1" name="Virfbore"
                                                        id="Virfbore" value="{{ $visual_packing->Virfbore }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <strong>Face</strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="face"
                                                        id="face" value="{{ $visual_packing->face }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 tot_rejection section1"
                                                        name="rad_chf" id="rad_chf"
                                                        value="{{ $visual_packing->rad_chf }}" required> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <strong>Width</strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="Virpw"
                                                        id="Virpw" value="{{ $visual_packing->Virpw }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <strong>Other</strong>
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="other"
                                                        id="other" value="{{ $visual_packing->other }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1"
                                                        name="bore_radius" id="bore_radius"
                                                        value="{{ $visual_packing->bore_radius }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="od_radius"
                                                        id="od_radius" value="{{ $visual_packing->od_radius }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1"
                                                        name="missing_operation" id="missing_operation"
                                                        value="{{ $visual_packing->missing_operation }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="vibration"
                                                        id="vibration" value="{{ $visual_packing->vibration }}" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="rust_burr"
                                                        id="rust_burr" value="{{ $visual_packing->rust_burr }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 section1" name="crack"
                                                        id="crack" value="{{ $visual_packing->crack }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1" name="packed_qty" 
                                                        id="packed_qty" value="{{ $visual_packing->packed_qty }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1" name="box_qty"
                                                        id="box_qty" value="{{ $visual_packing->box_qty }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==8) return false;" class="form-control1"
                                                        name="visual_inspected_qty" id="visual_inspected_qty"
                                                        value="{{ $visual_packing->visual_inspected_qty }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" min="0" oninput="this.value = Math.abs(this.value)" onKeyPress="if(this.value.length==3) return false;" class="form-control1 total"
                                                        name="total_rejection" id="total_rejection"
                                                        value="{{ $visual_packing->total_rejection }}" tabindex="-1" onclick="return false" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

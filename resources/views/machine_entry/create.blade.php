        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Add Machine Master</li>
                </ol>
            </div>
                        ...
                        <div class="card card-animate">
                            <div class="card-header">
                                <div class="row align-items-left">
                                    <div class="col">
                                        <h2 class="card-title-lg">Add Machine Master</h2>
                            ...
                            <div class="card-body">
                                <div class="tab-pane fade show active p-3 pt-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    {!! Form::open(['route' => 'machine_entry.store', 'method' => 'POST']) !!}
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::text('machine_name', null, ['placeholder' => 'Machine Name', 'class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::text('machine_model', null, ['placeholder' => 'Machine Model', 'class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                ...
                                                {!! Form::text('machine_make', null, ['placeholder' => 'Machine Make', 'class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group m-3">
                                                <strong>M/C Capacity :</strong>
                                                {!! Form::text('mc_capacity', null, ['placeholder' => 'M/C Capacity', 'class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
